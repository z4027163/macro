 ...
 */
      ...
      cout << "test middle weight= " << newweight << endl;
	   ...
	   njets_pass++;
           ...
           if(cSV_BTagJet_DISCR[i]> 0.5426){
              ...
              if( MC_type == "Spring16" && DATA_type == "NO"){
                 ...
                 if(RECOBOT_MatchingMCTruth[bot1+1]==2) scaleFactor = reader.eval_auto_bounds("central",BTagEntry::FLAV_C, Eta, Pt);
                 else if(RECOBOT_MatchingMCTruth[bot1+1]==1) scaleFactor = reader.eval_auto_bounds("central",BTagEntry::FLAV_B, Eta, Pt);
...
//          }
     ...
     hNbjets_8->Fill(nbtag_pass,newweight);
...
// qier (pick one/two bot)
     ...
     if( MC_type == "Spring16" && DATA_type == "NO"){
       ...
       if(scaleFactor1<=0) scaleFactor1=1;
       if(scaleFactor2<=0) scaleFactor2=1;
       ...
       if(debug) cout << "scale1= " << scaleFactor1 << endl;
       if(debug) cout << "scale2= " << scaleFactor2 << endl;
       ...
       else scaleFactor1_up = reader.eval_auto_bounds("up",BTagEntry::FLAV_UDSG, abs(Eta1), Pt1);
